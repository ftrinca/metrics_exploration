...
from injector.config import (
    CATEGORY_COLOR, DISTORTION_LABEL, DISTORTION_NAMES, METRIC_LABEL,
    PATTERNS, RANGE_BUCKETS, ordered_metrics,
)
...
def plot_metric_overview(z_by_condition, output_path, spreads_by_condition=None):
    ...
    distortions, on one color scale shared by every panel.
